<?php
	 ...
	 * @return array
	 */
	function secondary_title_merge_options($user_options = array(), $default_options = array(), $allow_empty = true) {
		...
		foreach($default_options as $default_option_name => $default_option_value) {
			...
			if(isset($user_options[$default_option_name])) {
				...
				if(!$allow_empty && empty($user_option_value)) {
	...
	function secondary_title_install() {
		if(get_option("secondary_title_installed")) {
			return false;
		}
		...
		return update_option("secondary_title_installed", true);
	}
	...
	function secondary_title_get_default_settings() {
		...
		$default_settings = array(
			...
			"secondary_title_column_position"        => "after"
		);
