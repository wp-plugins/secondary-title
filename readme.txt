...
**IMPORTANT:** If "Insert automatically" is not activated, you have to use either
...
in your theme to display the secondary title.

*the_secondary_title()* has the following parameters:
