=== Secondary Title ===
Contributors: Kolja Nolte
Tags: title
Tested up to: 3.8.1
Stable tag: 1.0
Requires at least: 3.1

Adds a secondary title to posts and custom post types.

== Description ==
Secondary Title is a simple, light-weight WordPress plugin that adds an alternative title to posts and custom post types.

It comes with an extra settings page which allows you to change:
	...
	- Automatic add to the main title
	- Custom title format
...
Bombs found in car --- No victims hurt
