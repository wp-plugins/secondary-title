...
shown on,
*	whether the secondary title should be automatically inserted with the standard title (*Insert automatically*),
*	the format both titles are being shown (only works when *Insert automatically* is activated),
